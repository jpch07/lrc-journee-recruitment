...
function profileHtml(profile) {
  ...
  const dimensionItems = dimensionOrder.map(code => ({ name: dimensionNames[code], score: dimensionGrade(result.dimensions?.[code]?.score) }));
